-- Phase 12: Reset PostgreSQL Database
-- Drops all tables, recreates them, and seeds baseline data
-- Usage: psql -h <host> -U <user> -d <db> -f reset_postgresql.sql
...
('NYC-001', 'New York Main', 'Northeast', True),
('LAX-001', 'Los Angeles', 'West', True),
('CHI-001', 'Chicago Central', 'Midwest', True),
('HOU-001', 'Houston South', 'South', False),
('MIA-001', 'Miami Beach', 'Southeast', True);
