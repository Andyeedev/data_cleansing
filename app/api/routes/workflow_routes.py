...
def create_workflow(
    ...
    db = get_db_connection()
    service = WorkflowService(db.conn, current_user.get("tenant_id"))
    return standardize_response(service.create_workflow(payload, current_user.get("sub")))
...
def execute_workflow(
    ...
    db = get_db_connection()
    service = WorkflowService(db.conn, current_user.get("tenant_id"))
    return standardize_response(service.execute_workflow(workflow_id, payload, current_user.get("sub")))
