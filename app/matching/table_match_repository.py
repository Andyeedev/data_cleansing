...
class TableMatchRepository:
    ...
    def insert_match_legacy(self, project_id, source_id, target_id, match):
    ...
    def upsert_match(self, project_id, source_id, target_id, match):
        ...
        ON CONFLICT (project_id, source_system_id, target_system_id, source_table)
        DO UPDATE SET
    ...
    def insert_match_details_legacy(self, match_id, metrics):
    ...
    def upsert_match_details(self, match_id, metrics):
        ...
        ON CONFLICT (match_id, metric_name)
        DO UPDATE SET
