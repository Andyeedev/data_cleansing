...
export const AreaChartWidget = ({ config, data }: WidgetProps) => {
    ...
    <WidgetBody>
      ...
      >
        <div className="text-center">
          <AreaChart className="w-12 h-12 text-neutral-60 mx-auto" />
          <p className="text-sm text-neutral-60 mt-2">Area Chart</p>
