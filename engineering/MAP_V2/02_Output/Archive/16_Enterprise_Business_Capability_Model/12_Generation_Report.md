...
| API Endpoints Mapped | 81 existing, 20 required |
| Database Tables Mapped | 45+ |
| Python Modules Mapped | 30+ |
...
| FastAPI Backend | 30+ routes | 81 endpoints across 10 route groups |
| React Frontend | 134 pages | 17 top-level menus, 103+ submenus |
| Database | 45+ tables | 5 schemas (core, engine, reporting, platform, audit) |
| SQL Views | 10 views | Executive, operational, governance, technical reporting |
...
|-------|-------------|--------|
| Phase 1 | Identify business capabilities in Python Engine | 14 engine capabilities |
| Phase 2 | Determine logical capability domains | 6 domains |
| Phase 3 | Map capabilities to purpose, owners, users, inputs, outputs | Complete capability profiles |
| Phase 4 | Determine capability hierarchy | 34 capabilities in 6 domains |
| Phase 5 | Determine capability dependencies | 3 dependency chains |
| Phase 6 | Determine business events | 24 events (14 engine, 10 platform) |
| Phase 7 | Determine platform consumers | 5 platform capabilities linked |
| Phase 8 | Produce enterprise capability map | Full traceability matrix |
| Phase 9 | Determine correct navigation hierarchy | 8 top-level menus (from 17) |
...
|--------|--------------|---------------------|
| Migration Management | 5 | 40% |
| Validation Management | 5 | 30% |
| Governance & Compliance | 4 | 40% |
| Reporting & Analytics | 6 | 17% |
| Platform Services | 6 | 67% |
| Administration | 8 | 50% |
| **Total** | **34** | **41%** |
...
Evidence:
- Only 2 of 34 capabilities have full API + Frontend coverage
...
| Capabilities without Frontend | 5 | Users cannot access |
...
| # | File | Lines | Purpose |
|---|------|-------|---------|
| 00 | 16_Enterprise_Business_Capability_Model.md | 486 | Master business architecture |
| 01 | Executive Summary | 86 | High-level findings |
| 02 | Business Capability Catalogue | 180 | Detailed capability profiles |
| 03 | Business Capability Hierarchy | 95 | Capability tree structure |
| 04 | Business Capability Dependencies | 120 | Dependency chains |
| 05 | Business Event Model | 150 | Event producer/consumer mapping |
| 06 | Capability to API Mapping | 111 | API endpoint mapping |
| 07 | Capability to Database Mapping | 140 | Database table mapping |
| 08 | Capability to Python Mapping | 130 | Python module mapping |
| 09 | Capability to Frontend Mapping | 160 | Frontend page mapping |
| 10 | Recommended Enterprise Navigation | 180 | Navigation architecture |
...
| Dependencies complete | PASS (3 chains) |
| Business events identified | PASS (24 events) |
| Platform consumers identified | PASS (5 consumers) |
