...
| 022 | Create AI Assistant | Previous — Sequential |
| 023 | Create AI Insights | Built upon — Insight data |
...
| Feature | Description |
|---------|-------------|
| Migration Recommendations | Data, schema, code migration |
| Optimization Recommendations | Performance, resource optimization |
| Governance Recommendations | Compliance, policy, audit |
| Security Recommendations | Access control, vulnerability |
| Risk Recommendations | Mitigation, avoidance, transfer |
| Workflow Recommendations | Process, automation, efficiency |
| Resource Recommendations | Capacity, cost optimization |
| Recommendation Prioritisation | 5 priority levels |
