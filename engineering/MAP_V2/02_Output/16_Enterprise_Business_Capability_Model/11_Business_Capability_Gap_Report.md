...
| Domain | Operational | Implemented | Proposed | Score |
|--------|-------------|-------------|----------|-------|
| Migration Management | 1 | 4 | 0 | 20% |
| Validation Management | 1 | 4 | 0 | 20% |
| Governance & Compliance | 1 | 3 | 0 | 25% |
| Reporting & Analytics | 0 | 6 | 0 | 0% |
| Platform Services | 5 | 0 | 1 | 83% |
| Administration | 6 | 1 | 2 | 75% |
...
|------------|---------|-----|----------|-----|----------|
| Project Management | IMPLEMENTED | PARTIAL | PARTIAL | Need full CRUD API | HIGH |
...
| Dataset Mapping | IMPLEMENTED | AUTO | PARTIAL | Need manual API | MEDIUM |
...
| Capability | Backend | API | Frontend | Gap | Priority |
|------------|---------|-----|----------|-----|----------|
| Rule Discovery | IMPLEMENTED | AUTO | PARTIAL | Need API + Real Frontend | HIGH |
...
| Dashboard Services | IMPLEMENTED | NONE | ALIGNED | Need API | HIGH |
...
| AI / MAP Copilot | PROPOSED | NONE | MOCK | Need Backend + API + Frontend | LOW |
...
| Tenant Management | PROPOSED | NONE | MOCK | Need Backend + API + Frontend | MEDIUM |
...
| Security Management | PROPOSED | NONE | MOCK | Need Backend + API + Frontend | MEDIUM |
...
|---|------------|---------------|-------------------|--------|
| 1 | Dataset Discovery | CLI only | /api/v1/discovery/* | HIGH |
| 2 | Column Mapping | Auto-created | /api/v1/column-mappings/* | MEDIUM |
| 3 | Control Discovery | Auto during execution | /api/v1/controls/* | MEDIUM |
| 4 | Governance Decisions | Auto post-execution | /api/v1/governance/* | HIGH |
| 5 | Risk Scoring | Auto post-execution | /api/v1/governance/risk/* | HIGH |
| 6 | Release Gates | Auto post-execution | /api/v1/governance/release/* | HIGH |
| 7 | Reporting (SQL Views) | BI tools only | /api/v1/reports/* | HIGH |
| 8 | Audit Trail | File-based | /api/v1/audit/* | MEDIUM |
...
| 6 | Export Services | None | Reports > Export | LOW |

### 4.3 Platform Capabilities Not Linked to Engine

| # | Capability | Current State | Required Integration | Effort |
|---|------------|---------------|---------------------|--------|
| 1 | Task Management | Platform-only | Subscribe to engine events | MEDIUM |
| 2 | Workflow Management | Platform-only | Link to engine milestones | MEDIUM |
| 3 | Notifications | Platform-only | Subscribe to engine events | LOW |
| 4 | Calendar | Platform-only | Link to engine milestones | LOW |
| 5 | AI / MAP Copilot | Frontend-local | Connect to engine APIs | HIGH |
