...
|---|--------|-----------|------------------|------------|
| 1 | Migration Management | 6 | 3.5 | Semi-Automated |
| 2 | Validation Management | 6 | 3.0 | Semi-Automated |
| 3 | Governance & Compliance | 2 | 3.5 | Semi-Automated |
| 4 | Reporting & Analytics | 2 | 2.0 | Assisted |
| 5 | Platform Services | 5 | 3.8 | Automated |
| 6 | Administration | 8 | 2.5 | Semi-Automated |
...
| Notifications → Engine | Disconnected | Medium | Platform-only, no engine event subscription |
| Tasks → Engine | Disconnected | Medium | Platform-only, no engine event subscription |
| Workflows → Engine | Disconnected | Medium | Platform-only, no engine event subscription |
