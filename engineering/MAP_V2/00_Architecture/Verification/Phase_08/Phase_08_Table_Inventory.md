...
| Type | Frontend Feature | Original Frontend Table | MAP CLI Equivalent | Actual Table Used by CLI | Row Count | Last Populated | Populated By | Business Purpose | Status | Notes | Action Required | Solution |
|------|------------------|-------------------------|-------------------|--------------------------|-----------|----------------|--------------|------------------|--------|-------|-----------------|----------|
| Auth | Login | `platform.users` | `platform.users` | `platform.users` | 1 | 2026-07-12 23:36:59 | `app/services/user_service.py:create_user` (line 76) | User accounts | ✅ VERIFIED | 1 admin user. Static seed data — managed by frontend, not MAP CLI. | None | No change needed |
