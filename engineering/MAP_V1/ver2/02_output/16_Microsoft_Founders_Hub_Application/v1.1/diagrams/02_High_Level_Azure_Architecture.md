# Diagram 2 — MAP Nexus™ High-Level Architecture
...
graph TB
    ...
    subgraph "Azure Platform"
        ...
        OAI["Azure OpenAI<br/>Intelligence (Future)"]
    end
    ...
    style AI fill:#764ba2,stroke:#667eea,color:#fff,stroke-dasharray: 5 5
    ...
    style OAI fill:#0078d4,stroke:#005a9e,color:#fff,stroke-dasharray: 5 5
```

**Figure 2:** MAP Nexus™ high-level architecture. Users access the platform through a secure web portal, with identity managed by Microsoft Entra ID. Business services orchestrate validation, governance, and reporting — all backed by Azure-native data, storage, and observability services. Future AI capabilities (dashed) will be delivered through Azure OpenAI within the same secure boundary.
